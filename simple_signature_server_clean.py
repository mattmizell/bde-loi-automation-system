...
class SignatureHandler(BaseHTTPRequestHandler):
            ...
            <div class="container">
                ...
                <div class="signature-panel">
                    ...
                    <div style="background: #f8f9fa; padding: 10px; border-radius: 4px; font-size: 12px; color: #666; margin-top: 20px;">
                        [Lock] <strong>Security:</strong> This signature is legally binding. Your IP address and timestamp will be recorded.
                    </div>
                </div>
            </div>
    ...
    def handle_signature_submission(self, post_data):
        ...
        try:
            ...
            logger.info(f"[Checkmark] Signature completed for {signature_request['signer_name']}")
...
def main():
    ...
    print("[Sign] Better Day Energy Signature Server Started!")
    print("[Globe] Access at: http://localhost:8001")
    print("[Email] Signature link sent to: matt.mizell@gmail.com")
    print("[Link] Direct signature URL: http://localhost:8001/sign/c2ea84c2-19b0-42f5-8c6e-4b9382b9df68")
    print("\n[Clipboard] Ready for Farely Barnhart to sign his LOI!")
